...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../DE2_115_Media_Computer.jdi
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x10002020
SOPC_SYSID_FLAG += --sidp=0x10002020
ELF_PATCH_FLAG  += --sidp 0x10002020

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1482343707
SOPC_SYSID_FLAG += --timestamp=1482343707
ELF_PATCH_FLAG  += --timestamp 1482343707
